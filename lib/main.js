...
var creator = (function () {
  ...
  _pub_static["getAllFormat"] = function (extDir) {
    ...
    var searchScriptDir = function (dir) {
      (_pri_static.config.showLoadLog ? console.log : debug)('search formatScriptDir : ', dir);
  ...
  _pub_static["getAllMode"] = function (extDir) {
    ...
    var searchScriptDir = function (dir) {
      (_pri_static.config.showLoadLog ? console.log : debug)('search modeScriptDir : ' + dir);
      $$walkDir(dir, null, parseFile);
    };
  ...
  _pri_static["config"] = {};
  _pub_static["scriptDirDefault"] = './xtranScript';
  _pub_static["addScriptDir"] = function (dir) {
    var dirPath = dir || $$path.join(process.cwd(), _pub_static.scriptDirDefault);
    _pub_static.config({
